...
the app be the same version or greater than the one which installed it. This mitigates downgrade attacks.
...
the code requirement generated by `PropertyListModifier.swift` build script mitigates older versions of the app from
